window.onload = function () {
    ...
    document.getElementById("submit-btn").addEventListener("click", () => {
      ...
      if (status.includes("false")) {
        ...
        fetch("https://dmezapi.herokuapp.com/api/v1/form/contacts", {
          method: "POST",
          ...
          .then((res) => {
            ...
            if (res.status === "success") {
              Swal.fire({
                icon: "success",
                title: "Yayyy",
                text: "You have successfully submitted your details! We will contact you soon!",
              });
    ...
    document.getElementById("suggest-btn").addEventListener("click", () => {
      ...
      if (name.length <= 1) {
        ...
        document.getElementById("labelSuggestName").innerHTML = "Please enter your name";
        status.push("false");
      } else {
        status.push("true");
      }
      ...
      if (suggestion.length < 10) {
        ...
        document.getElementById("labelSuggestion").innerHTML = "Please enter suggestion of more than 10 characters";
        status.push("false");
      } else {
        status.push("true");
      }
      ...
      if (status.includes("false")) {
        ...
        fetch("https://dmezapi.herokuapp.com/api/v1/form/suggestions", {
          method: "POST",
          headers: new Headers({ "content-type": "application/json" }),
          body: JSON.stringify({
            name: name,
