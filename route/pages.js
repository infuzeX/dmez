...
router.get("/account/info", (req, res) =>
  renderStaticPage(res, "setting.html")
);

router.get("/account/info/name", (req, res) =>
  renderStaticPage(res, "name.html")
);
router.get("/account/info/email", (req, res) =>
  renderStaticPage(res, "email.html")
);
router.get("/account/info/number", (req, res) =>
  renderStaticPage(res, "number.html")
);
router.get("/account/info/password", (req, res) =>
  renderStaticPage(res, "password.html")
);

router.get("/account/orders", (req, res) =>
  renderStaticPage(res, "order.html")
);

router.get("/account/address", (req, res) =>
  renderStaticPage(res, "address.html")
);
router.get("/account/address/edit", (req, res) =>
  renderStaticPage(res, "newaddress.html")
);
